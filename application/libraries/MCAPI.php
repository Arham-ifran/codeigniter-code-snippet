...
class MCAPI
{
    ...
    function __construct($config)
    {
        ...
        //$config['apikey'] =  '5763a3ffb3779ce814df1f9f33363211-us8';  
        $this->api_key = $config['apikey'];
        //$this->api_key =  '5763a3ffb3779ce814df1f9f33363211-us8';
    }
     ...
     * @param array $order an array of information pertaining to the order that has completed. Use the following keys:
      ...
      int type_id the store's internal Id for the (main) category associated with this product. Our testing has found this to be a "best guess" scenario
      string category_name the category name for the type_id this product is in. Our testing has found this to be a "best guess" scenario. Our plugins walk the category heirarchy up and send "Root - SubCat1 - SubCat4", etc.
