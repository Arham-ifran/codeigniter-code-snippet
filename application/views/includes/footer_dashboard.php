...
<footer>
    <div class="container wow animated fadeInDown">
        ...
        <div class="col-sm-4 connect col-xs-12 col-md-4">
            <h3>CONNECT</h3>
            <ul>
                <li><a target="_blank" href="<?php echo FACEBOOK; ?>"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a></li>
                <li><a target="_blank" href="<?php echo TWITTER; ?>"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a></li>
                <li><a target="_blank" href="<?php echo LINKEDIN; ?>"><i class="fa fa-linkedin" aria-hidden="true"></i> Linkedin</a></li>
                <!--<li><a target="_blank" href="<?php // echo GOOGLE; ?>"><i class="fa fa-google-plus" aria-hidden="true"></i> Google+</a></li>-->
            </ul>
        </div>
    </div>
